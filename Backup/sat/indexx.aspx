...
-->
    ...
    <body>
                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse collapse" id="templatemo-nav-bar">
                            <ul class="nav navbar-nav navbar-right" style="margin-top: 40px;">
                                ...
                                <a href="WebForm1.aspx">CERRAR SECCION</a>
                            </ul>
                        </div><!--/.nav-collapse -->
                    </div><!--/.container-fluid -->
                </div><!--/.navbar -->
        ...
        <div class="templatemo-t" id="Div1" dir="ltr" 
                ...
                <div class="row">
                    ...
                    <div class="templatemo-line-header">
                        <div class="text-center">
                            ...
                            <span style="font-family: 'TIMes New Roman', Times, serif; font-size: xx-large; font-weight: 900; font-style: inherit; color: #000000; text-decoration: underline;">REGISTRO</span>
                    ...
                    <td class="style2">
                        ...
                        <td class="style5">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                             ...
                             <img alt="" class="style6" src="images/predial.jpg" /> </a><td class="style20">
                            ...
                            <img alt="" class="style6" src="images/vehicular.jpg" /><td class="style20">
                ...
                <div class="row">
                    <div class="templatemo-line-header">
                        <div class="text-center">
                            ...
                            <span style="font-size: 20px; font-weight: 600; color: #0000FF; text-decoration: underline;">REGISTRO</span>
                            <hr class="team_hr team_hr_right" />
                       ...
                       <li class="col-lg-3 col-md-3 col-sm-6 " >
                            <div class="text-center">
                                ...
                                <div class="member-thumb" >
                                    ...
                                    <p class="team-inner-header" style="color: #0066CC">
                                        REGISTRO</p>
                                    <p class="team-inner-subtext" style="color:  #0066CC">PREDIAL</p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="col-lg-3 col-md-3 col-sm-6"    >
                            <div class="text-center">
                               <a href="Vehicular.aspx"> <div class="member-thumb">
                                    &nbsp;</div></a>
                                <div class="team-inner">
                                    <p class="team-inner-header" style="color:  #0066CC">REGISTRO</p>
                                    <p class="team-inner-subtext" style="color:  #0066CC">VEHICULAR</p>
                                </div>
                            </div>
                        </li>
        ...
        </div><!-- /.templatemo-team --><!-- /.templatemo-team -->
                ...
                <div class="row">
                    <div class="text-center">
                        ...
                        <div class="footer_container">
                            ...
                            <a class="btn btn-lg btn-orange" href="#" role="button" id="btn-back-to-top">Back To Topn-back-to-top">Back To Top</a>
                            <div class="height30"></div>
                        </div>
