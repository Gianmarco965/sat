                ...
                <div class="row">
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <td class="style7">
                            <asp:TextBox ID="nivel" runat="server"  placeholder="Nombres..." maxlength="50" Width="170px"></asp:TextBox>
                            </td>
                        <td class="style7">
                        ...
                        <td class="style7">
                                 <asp:TextBox ID="apellido" runat="server"  placeholder="Apellidos..." maxlength="50" Width="170px"></asp:TextBox> 
