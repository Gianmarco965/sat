            ...
            <div class="container">
                    ...
                    <div class="templatemo-line-header head_contact">
                        <div class="text-center">
                            ...
                            <span class="txt_darkgrey" 
                                ...
                                style="font-family: 'TIMes New Roman', Times, serif; font-size: 20px; font-weight: 900; color: #0000FF;">REG.DE PROPIETARIO DE VEHICULO</span>
                ...
                <table class="style1">
                   <tr>
                    ...
                    <tr>
                        <td class="style6">
                            <asp:Label ID="Label4" runat="server" Text="DNI:" Width="96px" 
                                Font-Size="13pt" Font-Bold="True" Font-Italic="False" ForeColor="#003399"></asp:Label>
                        </td>
                        <td class="style7">
                         <asp:TextBox ID="txtdniat" runat="server" 
